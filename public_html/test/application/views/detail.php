	...
	<form method="post" name="customerData" action="https://innovationsrus.in/payment/ccavRequestHandler.php">
		<h3 align="center" class="my-5">Detail</h3>
			<table width="70%" height="100" border='1' align="center">
				...
				<tr>
			<td>Order Id:</td><td><input type="text" name="order_id" value="<?php echo $a->Startup_id;
						
						?>" /></td>
				</tr>
				<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="<?php echo 1; ?>"/></td>
				</tr>
				<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value="<?php print_r($a->LeaderName);?>" /></td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	<td>Billing Mobile	:</td><td><input type="text" name="billing_tel" value="<?php print_r($a->Contact);?>"  /></td>
		        </tr>
		        <tr>
		        	<td>Billing Email	:</td><td><input type="text" name="billing_email" value="<?php print_r($a->LeaderEmail);?>" /></td>
		        </tr>
		    	<tr>
		     		<td colspan="2"></td>
		     	</tr>
