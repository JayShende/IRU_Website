...
$this->load->view('successst');
	...
	public function startupinsert(){
		$data=array(
			...
			'Udyam_Cert_Registration'=>$this->input->post('filename1'),
			'DPIIT_RegNo'=>$this->input->post('DPIIT'),
			'DPIIT_Certificate'=>$this->input->post('DPIITCertificate'),
			'Revenue_generated'=>$this->input->post('Revenue'),
			'Startup_Certificate'=>$this->input->post('filename2'),
	...
	public function inno_insert(){
		...
		//	'Billing_Pincode'=>$this->input->post('Billing_Pincode'),
			...
			'PatentCertificate'=>$this->input->post('patentcertificate'),
