...
<html lang="en">
 ...
 <link rel="icon" href="favicon(1).ico">
  ...
  <body>
    <header>
<h1 align="center" >Innovation Application Status</h1>
    </header>
<main class="main">
		<div class="container">
         ...
         <br>
          Email:
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  name="email" id="email" required />
             <br>
          <button type="button"  value="submit" class="button-form" onClick="innovationstatus();">Submit</button>	
        </form> 
        	</div>
...
var url = "<?=base_url;?>index.php/Welcome/checkinnovation?"+vars;
 //alert(url);
...
hr.send(vars);
	 	...
	 	function paynow(a,b)
	{
		...
		var vars = "order_id="+order_id+"&email="+email;
var hr = new XMLHttpRequest();
var url = "<?=base_url;?>index.php/Welcome/innopendingpayments?"+vars;
//alert(url);
hr.open("GET", url, true);
hr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
hr.onreadystatechange = function()
